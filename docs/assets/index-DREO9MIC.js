...
`)+`
`+h);const T=b+p+a,y=b+h+o,I=qa(s,s.VERTEX_SHADER,T),C=qa(s,s.FRAGMENT_SHADER,y);s.attachShader(M,I),s.attachShader(M,C),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(w){if(i.debug.checkShaderErrors){const k=s.getProgramInfoLog(M).trim(),z=s.getShaderInfoLog(I).trim(),j=s.getShaderInfoLog(C).trim();let Z=!0,Y=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,I,C);else{const $=Za(s,I,"vertex"),V=Za(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`;function Kf(i,t,e){let n=new Yr;const s=new Ct,r=new Ct,a=new Kt,o=new uc({depthPacking:Sl}),l=new dc,c={},u=e.maxTextureSize,d={[_n]:Ee,[Ee]:_n,[en]:en},f=new gn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ct},radius:{value:4}},vertexShader:jf,fragmentShader:Zf}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new vn;v.setAttribute("position",new We(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new He(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ro;let h=this.type;this.render=function(C,R,N){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;const E=i.getRenderTarget(),x=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),k=i.state;k.setBlending(pn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=h!==tn&&this.type===tn,j=h===tn&&this.type!==tn;for(let Z=0,Y=C.length;Z<Y;Z++){const $=C[Z],V=$.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const it=V.getFrameExtents();if(s.multiply(it),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/it.x),s.x=r.x*it.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/it.y),s.y=r.y*it.y,V.mapSize.y=r.y)),V.map===null||z===!0||j===!0){const gt=this.type!==tn?{minFilter:Ve,magFilter:Ve}:{};V.map!==null&&V.map.dispose(),V.map=new Un(s.x,s.y,gt),V.map.texture.name=$.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const ht=V.getViewportCount();for(let gt=0;gt<ht;gt++){const Nt=V.getViewport(gt);a.set(r.x*Nt.x,r.y*Nt.y,r.x*Nt.z,r.y*Nt.w),k.viewport(a),V.updateMatrices($,gt),n=V.getFrustum(),y(R,N,V.camera,$,this.type)}V.isPointLightShadow!==!0&&this.type===tn&&b(V,N),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(E,x,w)};function b(C,R){const N=t.update(M);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Un(s.x,s.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(R,null,N,f,M,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(R,null,N,m,M,null)}function T(C,R,N,E){let x=null;const w=N.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(w!==void 0)x=w;else if(x=N.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const k=x.uuid,z=R.uuid;let j=c[k];j===void 0&&(j={},c[k]=j);let Z=j[z];Z===void 0&&(Z=x.clone(),j[z]=Z,R.addEventListener("dispose",I)),x=Z}if(x.visible=R.visible,x.wireframe=R.wireframe,E===tn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:d[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,N.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const k=i.properties.get(x);k.light=N}return x}function y(C,R,N,E,x){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===tn)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,C.matrixWorld);const z=t.update(C),j=C.material;if(Array.isArray(j)){const Z=z.groups;for(let Y=0,$=Z.length;Y<$;Y++){const V=Z[Y],it=j[V.materialIndex];if(it&&it.visible){const ht=T(C,it,E,x);C.onBeforeShadow(i,C,R,N,z,ht,V),i.renderBufferDirect(N,null,z,ht,C,V),C.onAfterShadow(i,C,R,N,z,ht,V)}}}else if(j.visible){const Z=T(C,j,E,x);C.onBeforeShadow(i,C,R,N,z,Z,null),i.renderBufferDirect(N,null,z,Z,C,null),C.onAfterShadow(i,C,R,N,z,Z,null)}}const k=C.children;for(let z=0,j=k.length;z<j;z++)y(k[z],R,N,E,x)}function I(C){C.target.removeEventListener("dispose",I);for(const N in c){const E=c[N],x=C.target.uuid;x in E&&(E[x].dispose(),delete E[x])}}}const $f={[$s]:Js,[Qs]:nr,[tr]:ir,[ni]:er,[Js]:$s,[nr]:Qs,[ir]:tr,[er]:ni};function Jf(i,t){function e(){let P=!1;const at=new Kt;let H=null;const q=new Kt(0,0,0,0);return{setMask:function(lt){H!==lt&&!P&&(i.colorMask(lt,lt,lt,lt),H=lt)},setLocked:function(lt){P=lt},setClear:function(lt,ot,Pt,ie,fe){fe===!0&&(lt*=ie,ot*=ie,Pt*=ie),at.set(lt,ot,Pt,ie),q.equals(at)===!1&&(i.clearColor(lt,ot,Pt,ie),q.copy(at))},reset:function(){P=!1,H=null,q.set(-1,0,0,0)}}}function n(){let P=!1,at=!1,H=null,q=null,lt=null;return{setReversed:function(ot){if(at!==ot){const Pt=t.get("EXT_clip_control");ot?Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.ZERO_TO_ONE_EXT):Pt.clipControlEXT(Pt.LOWER_LEFT_EXT,Pt.NEGATIVE_ONE_TO_ONE_EXT),at=ot;const ie=lt;lt=null,this.setClear(ie)}},getReversed:function(){return at},setTest:function(ot){ot?st(i.DEPTH_TEST):St(i.DEPTH_TEST)},setMask:function(ot){H!==ot&&!P&&(i.depthMask(ot),H=ot)},setFunc:function(ot){if(at&&(ot=$f[ot]),q!==ot){switch(ot){case $s:i.depthFunc(i.NEVER);break;case Js:i.depthFunc(i.ALWAYS);break;case Qs:i.depthFunc(i.LESS);break;case ni:i.depthFunc(i.LEQUAL);break;case tr:i.depthFunc(i.EQUAL);break;case er:i.depthFunc(i.GEQUAL);break;case nr:i.depthFunc(i.GREATER);break;case ir:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}q=ot}},setLocked:function(ot){P=ot},setClear:function(ot){lt!==ot&&(at&&(ot=1-ot),i.clearDepth(ot),lt=ot)},reset:function(){P=!1,H=null,q=null,lt=null,at=!1}}}function s(){let P=!1,at=null,H=null,q=null,lt=null,ot=null,Pt=null,ie=null,fe=null;return{setTest:function(qt){P||(qt?st(i.STENCIL_TEST):St(i.STENCIL_TEST))},setMask:function(qt){at!==qt&&!P&&(i.stencilMask(qt),at=qt)},setFunc:function(qt,Ue,je){(H!==qt||q!==Ue||lt!==je)&&(i.stencilFunc(qt,Ue,je),H=qt,q=Ue,lt=je)},setOp:function(qt,Ue,je){(ot!==qt||Pt!==Ue||ie!==je)&&(i.stencilOp(qt,Ue,je),ot=qt,Pt=Ue,ie=je)},setLocked:function(qt){P=qt},setClear:function(qt){fe!==qt&&(i.clearStencil(qt),fe=qt)},reset:function(){P=!1,at=null,H=null,q=null,lt=null,ot=null,Pt=null,ie=null,fe=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,m=[],v=null,M=!1,p=null,h=null,b=null,T=null,y=null,I=null,C=null,R=new zt(0,0,0),N=0,E=!1,x=null,w=null,k=null,z=null,j=null;const Z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,$=0;const V=i.getParameter(i.VERSION);V.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(V)[1]),Y=$>=1):V.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),Y=$>=2);let it=null,ht={};const gt=i.getParameter(i.SCISSOR_BOX),Nt=i.getParameter(i.VIEWPORT),$t=new Kt().fromArray(gt),W=new Kt().fromArray(Nt);function tt(P,at,H,q){const lt=new Uint8Array(4),ot=i.createTexture();i.bindTexture(P,ot),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pt=0;Pt<H;Pt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(at,0,i.RGBA,1,1,q,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(at+Pt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return ot}const pt={};pt[i.TEXTURE_2D]=tt(i.TEXTURE_2D,i.TEXTURE_2D,1),pt[i.TEXTURE_CUBE_MAP]=tt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[i.TEXTURE_2D_ARRAY]=tt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),pt[i.TEXTURE_3D]=tt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),st(i.DEPTH_TEST),a.setFunc(ni),Ht(!1),Ot(ia),st(i.CULL_FACE),A(pn);function st(P){u[P]!==!0&&(i.enable(P),u[P]=!0)}function St(P){u[P]!==!1&&(i.disable(P),u[P]=!1)}function Wt(P,at){return d[P]!==at?(i.bindFramebuffer(P,at),d[P]=at,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=at),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=at),!0):!1}function bt(P,at){let H=m,q=!1;if(P){H=f.get(at),H===void 0&&(H=[],f.set(at,H));const lt=P.textures;if(H.length!==lt.length||H[0]!==i.COLOR_ATTACHMENT0){for(let ot=0,Pt=lt.length;ot<Pt;ot++)H[ot]=i.COLOR_ATTACHMENT0+ot;H.length=lt.length,q=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,q=!0);q&&i.drawBuffers(H)}function re(P){return v!==P?(i.useProgram(P),v=P,!0):!1}const ee={[wn]:i.FUNC_ADD,[qo]:i.FUNC_SUBTRACT,[jo]:i.FUNC_REVERSE_SUBTRACT};ee[Zo]=i.MIN,ee[Ko]=i.MAX;const Ft={[$o]:i.ZERO,[Jo]:i.ONE,[Qo]:i.SRC_COLOR,[Zs]:i.SRC_ALPHA,[rl]:i.SRC_ALPHA_SATURATE,[il]:i.DST_COLOR,[el]:i.DST_ALPHA,[tl]:i.ONE_MINUS_SRC_COLOR,[Ks]:i.ONE_MINUS_SRC_ALPHA,[sl]:i.ONE_MINUS_DST_COLOR,[nl]:i.ONE_MINUS_DST_ALPHA,[al]:i.CONSTANT_COLOR,[ol]:i.ONE_MINUS_CONSTANT_COLOR,[ll]:i.CONSTANT_ALPHA,[cl]:i.ONE_MINUS_CONSTANT_ALPHA};function A(P,at,H,q,lt,ot,Pt,ie,fe,qt){if(P===pn){M===!0&&(St(i.BLEND),M=!1);return}if(M===!1&&(st(i.BLEND),M=!0),P!==Yo){if(P!==p||qt!==E){if((h!==wn||y!==wn)&&(i.blendEquation(i.FUNC_ADD),h=wn,y=wn),qt)switch(P){case ti:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sa:i.blendFunc(i.ONE,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case aa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case ti:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case aa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}b=null,T=null,I=null,C=null,R.set(0,0,0),N=0,p=P,E=qt}return}lt=lt||at,ot=ot||H,Pt=Pt||q,(at!==h||lt!==y)&&(i.blendEquationSeparate(ee[at],ee[lt]),h=at,y=lt),(H!==b||q!==T||ot!==I||Pt!==C)&&(i.blendFuncSeparate(Ft[H],Ft[q],Ft[ot],Ft[Pt]),b=H,T=q,I=ot,C=Pt),(ie.equals(R)===!1||fe!==N)&&(i.blendColor(ie.r,ie.g,ie.b,fe),R.copy(ie),N=fe),p=P,E=!1}function we(P,at){P.side===en?St(i.CULL_FACE):st(i.CULL_FACE);let H=P.side===Ee;at&&(H=!H),Ht(H),P.blending===ti&&P.transparent===!1?A(pn):A(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);const q=P.stencilWrite;o.setTest(q),q&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Qt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?st(i.SAMPLE_ALPHA_TO_COVERAGE):St(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ht(P){x!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),x=P)}function Ot(P){P!==ko?(st(i.CULL_FACE),P!==w&&(P===ia?i.cullFace(i.BACK):P===Wo?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):St(i.CULL_FACE),w=P}function vt(P){P!==k&&(Y&&i.lineWidth(P),k=P)}function Qt(P,at,H){P?(st(i.POLYGON_OFFSET_FILL),(z!==at||j!==H)&&(i.polygonOffset(at,H),z=at,j=H)):St(i.POLYGON_OFFSET_FILL)}function _t(P){P?st(i.SCISSOR_TEST):St(i.SCISSOR_TEST)}function S(P){P===void 0&&(P=i.TEXTURE0+Z-1),it!==P&&(i.activeTexture(P),it=P)}function _(P,at,H){H===void 0&&(it===null?H=i.TEXTURE0+Z-1:H=it);let q=ht[H];q===void 0&&(q={type:void 0,texture:void 0},ht[H]=q),(q.type!==P||q.texture!==at)&&(it!==H&&(i.activeTexture(H),it=H),i.bindTexture(P,at||pt[P]),q.type=P,q.texture=at)}function F(){const P=ht[it];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function X(){try{i.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{i.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function G(){try{i.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function mt(){try{i.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function rt(){try{i.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Et(){try{i.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function yt(){try{i.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{i.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ut(){try{i.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Tt(){try{i.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Rt(P){$t.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),$t.copy(P))}function dt(P){W.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),W.copy(P))}function Bt(P,at){let H=c.get(at);H===void 0&&(H=new WeakMap,c.set(at,H));let q=H.get(P);q===void 0&&(q=i.getUniformBlockIndex(at,P.name),H.set(P,q))}function Lt(P,at){const q=c.get(at).get(P);l.get(at)!==q&&(i.uniformBlockBinding(at,q,P.__bindingPointIndex),l.set(at,q))}function Jt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},it=null,ht={},d={},f=new WeakMap,m=[],v=null,M=!1,p=null,h=null,b=null,T=null,y=null,I=null,C=null,R=new zt(0,0,0),N=0,E=!1,x=null,w=null,k=null,z=null,j=null,$t.set(0,0,i.canvas.width,i.canvas.height),W.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:st,disable:St,bindFramebuffer:Wt,drawBuffers:bt,useProgram:re,setBlending:A,setMaterial:we,setFlipSided:Ht,setCullFace:Ot,setLineWidth:vt,setPolygonOffset:Qt,setScissorTest:_t,activeTexture:S,bindTexture:_,unbindTexture:F,compressedTexImage2D:X,compressedTexImage3D:K,texImage2D:ut,texImage3D:Tt,updateUBOMapping:Bt,uniformBlockBinding:Lt,texStorage2D:yt,texStorage3D:J,texSubImage2D:G,texSubImage3D:mt,compressedTexSubImage2D:rt,compressedTexSubImage3D:Et,scissor:Rt,viewport:dt,reset:Jt}}function Qf(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ct,u=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(S,_){return m?new OffscreenCanvas(S,_):Ei("canvas")}function M(S,_,F){let X=1;const K=_t(S);if((K.width>F||K.height>F)&&(X=F/Math.max(K.width,K.height)),X<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const G=Math.floor(X*K.width),mt=Math.floor(X*K.height);d===void 0&&(d=v(G,mt));const rt=_?v(G,mt):d;return rt.width=G,rt.height=mt,rt.getContext("2d").drawImage(S,0,0,G,mt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+G+"x"+mt+")."),rt}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),S;return S}function p(S){return S.generateMipmaps}function h(S){i.generateMipmap(S)}function b(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(S,_,F,X,K=!1){if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let G=_;if(_===i.RED&&(F===i.FLOAT&&(G=i.R32F),F===i.HALF_FLOAT&&(G=i.R16F),F===i.UNSIGNED_BYTE&&(G=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.R8UI),F===i.UNSIGNED_SHORT&&(G=i.R16UI),F===i.UNSIGNED_INT&&(G=i.R32UI),F===i.BYTE&&(G=i.R8I),F===i.SHORT&&(G=i.R16I),F===i.INT&&(G=i.R32I)),_===i.RG&&(F===i.FLOAT&&(G=i.RG32F),F===i.HALF_FLOAT&&(G=i.RG16F),F===i.UNSIGNED_BYTE&&(G=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RG8UI),F===i.UNSIGNED_SHORT&&(G=i.RG16UI),F===i.UNSIGNED_INT&&(G=i.RG32UI),F===i.BYTE&&(G=i.RG8I),F===i.SHORT&&(G=i.RG16I),F===i.INT&&(G=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RGB8UI),F===i.UNSIGNED_SHORT&&(G=i.RGB16UI),F===i.UNSIGNED_INT&&(G=i.RGB32UI),F===i.BYTE&&(G=i.RGB8I),F===i.SHORT&&(G=i.RGB16I),F===i.INT&&(G=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(G=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(G=i.RGBA16UI),F===i.UNSIGNED_INT&&(G=i.RGBA32UI),F===i.BYTE&&(G=i.RGBA8I),F===i.SHORT&&(G=i.RGBA16I),F===i.INT&&(G=i.RGBA32I)),_===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(G=i.RGB9_E5),_===i.RGBA){const mt=K?ls:kt.getTransfer(X);F===i.FLOAT&&(G=i.RGBA32F),F===i.HALF_FLOAT&&(G=i.RGBA16F),F===i.UNSIGNED_BYTE&&(G=mt===jt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(G=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(G=i.RGB5_A1)}return(G===i.R16F||G===i.R32F||G===i.RG16F||G===i.RG32F||G===i.RGBA16F||G===i.RGBA32F)&&t.get("EXT_color_buffer_float"),G}function y(S,_){let F;return S?_===null||_===Ln||_===xi?F=i.DEPTH24_STENCIL8:_===nn?F=i.DEPTH32F_STENCIL8:_===vi&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Ln||_===xi?F=i.DEPTH_COMPONENT24:_===nn?F=i.DEPTH_COMPONENT32F:_===vi&&(F=i.DEPTH_COMPONENT16),F}function I(S,_){return p(S)===!0||S.isFramebufferTexture&&S.minFilter!==Ve&&S.minFilter!==ke?Math.log2(Math.max(_.width,_.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?_.mipmaps.length:1}function C(S){const _=S.target;_.removeEventListener("dispose",C),N(_),_.isVideoTexture&&u.delete(_)}function R(S){const _=S.target;_.removeEventListener("dispose",R),x(_)}function N(S){const _=n.get(S);if(_.__webglInit===void 0)return;const F=S.source,X=f.get(F);if(X){const K=X[_.__cacheKey];K.usedTimes--,K.usedTimes===0&&E(S),Object.keys(X).length===0&&f.delete(F)}n.remove(S)}function E(S){const _=n.get(S);i.deleteTexture(_.__webglTexture);const F=S.source,X=f.get(F);delete X[_.__cacheKey],a.memory.textures--}function x(S){const _=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let K=0;K<_.__webglFramebuffer[X].length;K++)i.deleteFramebuffer(_.__webglFramebuffer[X][K]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=S.textures;for(let X=0,K=F.length;X<K;X++){const G=n.get(F[X]);G.__webglTexture&&(i.deleteTexture(G.__webglTexture),a.memory.textures--),n.remove(F[X])}n.remove(S)}let w=0;function k(){w=0}function z(){const S=w;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),w+=1,S}function j(S){const _=[];return _.push(S.wrapS),_.push(S.wrapT),_.push(S.wrapR||0),_.push(S.magFilter),_.push(S.minFilter),_.push(S.anisotropy),_.push(S.internalFormat),_.push(S.format),_.push(S.type),_.push(S.generateMipmaps),_.push(S.premultiplyAlpha),_.push(S.flipY),_.push(S.unpackAlignment),_.push(S.colorSpace),_.join()}function Z(S,_){const F=n.get(S);if(S.isVideoTexture&&vt(S),S.isRenderTargetTexture===!1&&S.version>0&&F.__version!==S.version){const X=S.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{W(F,S,_);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function Y(S,_){const F=n.get(S);if(S.version>0&&F.__version!==S.version){W(F,S,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function $(S,_){const F=n.get(S);if(S.version>0&&F.__version!==S.version){W(F,S,_);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function V(S,_){const F=n.get(S);if(S.version>0&&F.__version!==S.version){tt(F,S,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const it={[ar]:i.REPEAT,[Pn]:i.CLAMP_TO_EDGE,[or]:i.MIRRORED_REPEAT},ht={[Ve]:i.NEAREST,[xl]:i.NEAREST_MIPMAP_NEAREST,[Di]:i.NEAREST_MIPMAP_LINEAR,[ke]:i.LINEAR,[gs]:i.LINEAR_MIPMAP_NEAREST,[Dn]:i.LINEAR_MIPMAP_LINEAR},gt={[yl]:i.NEVER,[Cl]:i.ALWAYS,[Tl]:i.LESS,[vo]:i.LEQUAL,[bl]:i.EQUAL,[wl]:i.GEQUAL,[Al]:i.GREATER,[Rl]:i.NOTEQUAL};function Nt(S,_){if(_.type===nn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===ke||_.magFilter===gs||_.magFilter===Di||_.magFilter===Dn||_.minFilter===ke||_.minFilter===gs||_.minFilter===Di||_.minFilter===Dn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,it[_.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,it[_.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,it[_.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,ht[_.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,ht[_.minFilter]),_.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,gt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ve||_.minFilter!==Di&&_.minFilter!==Dn||_.type===nn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(S,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function $t(S,_){let F=!1;S.__webglInit===void 0&&(S.__webglInit=!0,_.addEventListener("dispose",C));const X=_.source;let K=f.get(X);K===void 0&&(K={},f.set(X,K));const G=j(_);if(G!==S.__cacheKey){K[G]===void 0&&(K[G]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),K[G].usedTimes++;const mt=K[S.__cacheKey];mt!==void 0&&(K[S.__cacheKey].usedTimes--,mt.usedTimes===0&&E(_)),S.__cacheKey=G,S.__webglTexture=K[G].texture}return F}function W(S,_,F){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const K=$t(S,_),G=_.source;e.bindTexture(X,S.__webglTexture,i.TEXTURE0+F);const mt=n.get(G);if(G.version!==mt.__version||K===!0){e.activeTexture(i.TEXTURE0+F);const rt=kt.getPrimaries(kt.workingColorSpace),Et=_.colorSpace===fn?null:kt.getPrimaries(_.colorSpace),yt=_.colorSpace===fn||rt===Et?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,yt);let J=M(_.image,!1,s.maxTextureSize);J=Qt(_,J);const ut=r.convert(_.format,_.colorSpace),Tt=r.convert(_.type);let Rt=T(_.internalFormat,ut,Tt,_.colorSpace,_.isVideoTexture);Nt(X,_);let dt;const Bt=_.mipmaps,Lt=_.isVideoTexture!==!0,Jt=mt.__version===void 0||K===!0,P=G.dataReady,at=I(_,J);if(_.isDepthTexture)Rt=y(_.format===Si,_.type),Jt&&(Lt?e.texStorage2D(i.TEXTURE_2D,1,Rt,J.width,J.height):e.texImage2D(i.TEXTURE_2D,0,Rt,J.width,J.height,0,ut,Tt,null));else if(_.isDataTexture)if(Bt.length>0){Lt&&Jt&&e.texStorage2D(i.TEXTURE_2D,at,Rt,Bt[0].width,Bt[0].height);for(let H=0,q=Bt.length;H<q;H++)dt=Bt[H],Lt?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,dt.width,dt.height,ut,Tt,dt.data):e.texImage2D(i.TEXTURE_2D,H,Rt,dt.width,dt.height,0,ut,Tt,dt.data);_.generateMipmaps=!1}else Lt?(Jt&&e.texStorage2D(i.TEXTURE_2D,at,Rt,J.width,J.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,J.width,J.height,ut,Tt,J.data)):e.texImage2D(i.TEXTURE_2D,0,Rt,J.width,J.height,0,ut,Tt,J.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Lt&&Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,at,Rt,Bt[0].width,Bt[0].height,J.depth);for(let H=0,q=Bt.length;H<q;H++)if(dt=Bt[H],_.format!==ze)if(ut!==null)if(Lt){if(P)if(_.layerUpdates.size>0){const lt=La(dt.width,dt.height,_.format,_.type);for(const ot of _.layerUpdates){const Pt=dt.data.subarray(ot*lt/dt.data.BYTES_PER_ELEMENT,(ot+1)*lt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,ot,dt.width,dt.height,1,ut,Pt)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,dt.width,dt.height,J.depth,ut,dt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,Rt,dt.width,dt.height,J.depth,0,dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,dt.width,dt.height,J.depth,ut,Tt,dt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,H,Rt,dt.width,dt.height,J.depth,0,ut,Tt,dt.data)}else{Lt&&Jt&&e.texStorage2D(i.TEXTURE_2D,at,Rt,Bt[0].width,Bt[0].height);for(let H=0,q=Bt.length;H<q;H++)dt=Bt[H],_.format!==ze?ut!==null?Lt?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,dt.width,dt.height,ut,dt.data):e.compressedTexImage2D(i.TEXTURE_2D,H,Rt,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,dt.width,dt.height,ut,Tt,dt.data):e.texImage2D(i.TEXTURE_2D,H,Rt,dt.width,dt.height,0,ut,Tt,dt.data)}else if(_.isDataArrayTexture)if(Lt){if(Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,at,Rt,J.width,J.height,J.depth),P)if(_.layerUpdates.size>0){const H=La(J.width,J.height,_.format,_.type);for(const q of _.layerUpdates){const lt=J.data.subarray(q*H/J.data.BYTES_PER_ELEMENT,(q+1)*H/J.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,q,J.width,J.height,1,ut,Tt,lt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ut,Tt,J.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Rt,J.width,J.height,J.depth,0,ut,Tt,J.data);else if(_.isData3DTexture)Lt?(Jt&&e.texStorage3D(i.TEXTURE_3D,at,Rt,J.width,J.height,J.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ut,Tt,J.data)):e.texImage3D(i.TEXTURE_3D,0,Rt,J.width,J.height,J.depth,0,ut,Tt,J.data);else if(_.isFramebufferTexture){if(Jt)if(Lt)e.texStorage2D(i.TEXTURE_2D,at,Rt,J.width,J.height);else{let H=J.width,q=J.height;for(let lt=0;lt<at;lt++)e.texImage2D(i.TEXTURE_2D,lt,Rt,H,q,0,ut,Tt,null),H>>=1,q>>=1}}else if(Bt.length>0){if(Lt&&Jt){const H=_t(Bt[0]);e.texStorage2D(i.TEXTURE_2D,at,Rt,H.width,H.height)}for(let H=0,q=Bt.length;H<q;H++)dt=Bt[H],Lt?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,ut,Tt,dt):e.texImage2D(i.TEXTURE_2D,H,Rt,ut,Tt,dt);_.generateMipmaps=!1}else if(Lt){if(Jt){const H=_t(J);e.texStorage2D(i.TEXTURE_2D,at,Rt,H.width,H.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ut,Tt,J)}else e.texImage2D(i.TEXTURE_2D,0,Rt,ut,Tt,J);p(_)&&h(X),mt.__version=G.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function tt(S,_,F){if(_.image.length!==6)return;const X=$t(S,_),K=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+F);const G=n.get(K);if(K.version!==G.__version||X===!0){e.activeTexture(i.TEXTURE0+F);const mt=kt.getPrimaries(kt.workingColorSpace),rt=_.colorSpace===fn?null:kt.getPrimaries(_.colorSpace),Et=_.colorSpace===fn||mt===rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Et);const yt=_.isCompressedTexture||_.image[0].isCompressedTexture,J=_.image[0]&&_.image[0].isDataTexture,ut=[];for(let q=0;q<6;q++)!yt&&!J?ut[q]=M(_.image[q],!0,s.maxCubemapSize):ut[q]=J?_.image[q].image:_.image[q],ut[q]=Qt(_,ut[q]);const Tt=ut[0],Rt=r.convert(_.format,_.colorSpace),dt=r.convert(_.type),Bt=T(_.internalFormat,Rt,dt,_.colorSpace),Lt=_.isVideoTexture!==!0,Jt=G.__version===void 0||X===!0,P=K.dataReady;let at=I(_,Tt);Nt(i.TEXTURE_CUBE_MAP,_);let H;if(yt){Lt&&Jt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,at,Bt,Tt.width,Tt.height);for(let q=0;q<6;q++){H=ut[q].mipmaps;for(let lt=0;lt<H.length;lt++){const ot=H[lt];_.format!==ze?Rt!==null?Lt?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt,0,0,ot.width,ot.height,Rt,ot.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt,Bt,ot.width,ot.height,0,ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt,0,0,ot.width,ot.height,Rt,dt,ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt,Bt,ot.width,ot.height,0,Rt,dt,ot.data)}}}else{if(H=_.mipmaps,Lt&&Jt){H.length>0&&at++;const q=_t(ut[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,at,Bt,q.width,q.height)}for(let q=0;q<6;q++)if(J){Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,ut[q].width,ut[q].height,Rt,dt,ut[q].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Bt,ut[q].width,ut[q].height,0,Rt,dt,ut[q].data);for(let lt=0;lt<H.length;lt++){const Pt=H[lt].image[q].image;Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt+1,0,0,Pt.width,Pt.height,Rt,dt,Pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt+1,Bt,Pt.width,Pt.height,0,Rt,dt,Pt.data)}}else{Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,Rt,dt,ut[q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Bt,Rt,dt,ut[q]);for(let lt=0;lt<H.length;lt++){const ot=H[lt];Lt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt+1,0,0,Rt,dt,ot.image[q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+q,lt+1,Bt,Rt,dt,ot.image[q])}}}p(_)&&h(i.TEXTURE_CUBE_MAP),G.__version=K.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function pt(S,_,F,X,K,G){const mt=r.convert(F.format,F.colorSpace),rt=r.convert(F.type),Et=T(F.internalFormat,mt,rt,F.colorSpace),yt=n.get(_),J=n.get(F);if(J.__renderTarget=_,!yt.__hasExternalTextures){const ut=Math.max(1,_.width>>G),Tt=Math.max(1,_.height>>G);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?e.texImage3D(K,G,Et,ut,Tt,_.depth,0,mt,rt,null):e.texImage2D(K,G,Et,ut,Tt,0,mt,rt,null)}e.bindFramebuffer(i.FRAMEBUFFER,S),Ot(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,K,J.__webglTexture,0,Ht(_)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,K,J.__webglTexture,G),e.bindFramebuffer(i.FRAMEBUFFER,null)}function st(S,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,S),_.depthBuffer){const X=_.depthTexture,K=X&&X.isDepthTexture?X.type:null,G=y(_.stencilBuffer,K),mt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,rt=Ht(_);Ot(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt,G,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt,G,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,G,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,mt,i.RENDERBUFFER,S)}else{const X=_.textures;for(let K=0;K<X.length;K++){const G=X[K],mt=r.convert(G.format,G.colorSpace),rt=r.convert(G.type),Et=T(G.internalFormat,mt,rt,G.colorSpace),yt=Ht(_);F&&Ot(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,yt,Et,_.width,_.height):Ot(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,yt,Et,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Et,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function St(S,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,S),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(_.depthTexture);X.__renderTarget=_,(!X.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Z(_.depthTexture,0);const K=X.__webglTexture,G=Ht(_);if(_.depthTexture.format===Mi)Ot(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(_.depthTexture.format===Si)Ot(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function Wt(S){const _=n.get(S),F=S.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==S.depthTexture){const X=S.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const K=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",K)};X.addEventListener("dispose",K),_.__depthDisposeCallback=K}_.__boundDepthTexture=X}if(S.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const X=S.texture.mipmaps;X&&X.length>0?St(_.__webglFramebuffer[0],S):St(_.__webglFramebuffer,S)}else if(F){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=i.createRenderbuffer(),st(_.__webglDepthbuffer[X],S,!1);else{const K=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,G)}}else{const X=S.texture.mipmaps;if(X&&X.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),st(_.__webglDepthbuffer,S,!1);else{const K=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,G),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,G)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function bt(S,_,F){const X=n.get(S);_!==void 0&&pt(X.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Wt(S)}function re(S){const _=S.texture,F=n.get(S),X=n.get(_);S.addEventListener("dispose",R);const K=S.textures,G=S.isWebGLCubeRenderTarget===!0,mt=K.length>1;if(mt||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,a.memory.textures++),G){F.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[rt]=[];for(let Et=0;Et<_.mipmaps.length;Et++)F.__webglFramebuffer[rt][Et]=i.createFramebuffer()}else F.__webglFramebuffer[rt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let rt=0;rt<_.mipmaps.length;rt++)F.__webglFramebuffer[rt]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(mt)for(let rt=0,Et=K.length;rt<Et;rt++){const yt=n.get(K[rt]);yt.__webglTexture===void 0&&(yt.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&Ot(S)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let rt=0;rt<K.length;rt++){const Et=K[rt];F.__webglColorRenderbuffer[rt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[rt]);const yt=r.convert(Et.format,Et.colorSpace),J=r.convert(Et.type),ut=T(Et.internalFormat,yt,J,Et.colorSpace,S.isXRRenderTarget===!0),Tt=Ht(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Tt,ut,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,F.__webglColorRenderbuffer[rt])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),st(F.__webglDepthRenderbuffer,S,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(G){e.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Nt(i.TEXTURE_CUBE_MAP,_);for(let rt=0;rt<6;rt++)if(_.mipmaps&&_.mipmaps.length>0)for(let Et=0;Et<_.mipmaps.length;Et++)pt(F.__webglFramebuffer[rt][Et],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Et);else pt(F.__webglFramebuffer[rt],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);p(_)&&h(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(mt){for(let rt=0,Et=K.length;rt<Et;rt++){const yt=K[rt],J=n.get(yt);e.bindTexture(i.TEXTURE_2D,J.__webglTexture),Nt(i.TEXTURE_2D,yt),pt(F.__webglFramebuffer,S,yt,i.COLOR_ATTACHMENT0+rt,i.TEXTURE_2D,0),p(yt)&&h(i.TEXTURE_2D)}e.unbindTexture()}else{let rt=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(rt=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(rt,X.__webglTexture),Nt(rt,_),_.mipmaps&&_.mipmaps.length>0)for(let Et=0;Et<_.mipmaps.length;Et++)pt(F.__webglFramebuffer[Et],S,_,i.COLOR_ATTACHMENT0,rt,Et);else pt(F.__webglFramebuffer,S,_,i.COLOR_ATTACHMENT0,rt,0);p(_)&&h(rt),e.unbindTexture()}S.depthBuffer&&Wt(S)}function ee(S){const _=S.textures;for(let F=0,X=_.length;F<X;F++){const K=_[F];if(p(K)){const G=b(S),mt=n.get(K).__webglTexture;e.bindTexture(G,mt),h(G),e.unbindTexture()}}}const Ft=[],A=[];function we(S){if(S.samples>0){if(Ot(S)===!1){const _=S.textures,F=S.width,X=S.height;let K=i.COLOR_BUFFER_BIT;const G=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,mt=n.get(S),rt=_.length>1;if(rt)for(let yt=0;yt<_.length;yt++)e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+yt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+yt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,mt.__webglMultisampledFramebuffer);const Et=S.texture.mipmaps;Et&&Et.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglFramebuffer);for(let yt=0;yt<_.length;yt++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),rt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,mt.__webglColorRenderbuffer[yt]);const J=n.get(_[yt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,J,0)}i.blitFramebuffer(0,0,F,X,0,0,F,X,K,i.NEAREST),l===!0&&(Ft.length=0,A.length=0,Ft.push(i.COLOR_ATTACHMENT0+yt),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ft.push(G),A.push(G),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,A)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ft))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),rt)for(let yt=0;yt<_.length;yt++){e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+yt,i.RENDERBUFFER,mt.__webglColorRenderbuffer[yt]);const J=n.get(_[yt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+yt,i.TEXTURE_2D,J,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const _=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ht(S){return Math.min(s.maxSamples,S.samples)}function Ot(S){const _=n.get(S);return S.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function vt(S){const _=a.render.frame;u.get(S)!==_&&(u.set(S,_),S.update())}function Qt(S,_){const F=S.colorSpace,X=S.format,K=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||F!==ri&&F!==fn&&(kt.getTransfer(F)===jt?(X!==ze||K!==Ye)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function _t(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.setTexture2D=Z,this.setTexture2DArray=Y,this.setTexture3D=$,this.setTextureCube=V,this.rebindTextures=bt,this.setupRenderTarget=re,this.updateRenderTargetMipmap=ee,this.updateMultisampleRenderTarget=we,this.setupDepthRenderbuffer=Wt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=Ot}function tp(i,t){function e(n,s=fn){let r;const a=kt.getTransfer(s);if(n===Ye)return i.UNSIGNED_BYTE;if(n===Br)return i.UNSIGNED_SHORT_4_4_4_4;if(n===zr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ho)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===lo)return i.BYTE;if(n===co)return i.SHORT;if(n===vi)return i.UNSIGNED_SHORT;if(n===Or)return i.INT;if(n===Ln)return i.UNSIGNED_INT;if(n===nn)return i.FLOAT;if(n===Ti)return i.HALF_FLOAT;if(n===uo)return i.ALPHA;if(n===fo)return i.RGB;if(n===ze)return i.RGBA;if(n===Mi)return i.DEPTH_COMPONENT;if(n===Si)return i.DEPTH_STENCIL;if(n===po)return i.RED;if(n===Hr)return i.RED_INTEGER;if(n===mo)return i.RG;if(n===Vr)return i.RG_INTEGER;if(n===Gr)return i.RGBA_INTEGER;if(n===ts||n===es||n===ns||n===is)if(a===jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ts)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===es)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ns)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ts)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===es)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ns)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===is)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===lr||n===cr||n===hr||n===ur)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===lr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===cr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===hr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ur)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===dr||n===fr||n===pr)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===dr||n===fr)return a===jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===pr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===mr||n===_r||n===gr||n===vr||n===xr||n===Mr||n===Sr||n===Er||n===yr||n===Tr||n===br||n===Ar||n===Rr||n===wr)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===mr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===_r)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===gr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===vr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===xr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Mr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Sr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Er)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===yr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Tr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===br)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ar)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Rr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===wr)return a===jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ss||n===Cr||n===Pr)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===ss)return a===jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Cr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Pr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===_o||n===Dr||n===Lr||n===Ur)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===ss)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Dr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ur)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===xi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const ep=`
void main() {
